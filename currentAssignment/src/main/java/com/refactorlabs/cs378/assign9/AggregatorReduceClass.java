 ...
 */
public class AggregatorReduceClass
extends Reducer<Text, AvroValue<ClickSubtypeStatisticsData>,
Text, AvroValue<ClickSubtypeStatisticsData>> {

	@Override
	public void reduce(Text key, Iterable<AvroValue<ClickSubtypeStatisticsData>> values, Context context)
