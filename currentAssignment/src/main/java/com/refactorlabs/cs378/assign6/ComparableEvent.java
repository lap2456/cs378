 ...
 * 
 * ComparableEvent class stores an impression object and implements the comparable
...
public class ComparableEvent implements Comparable<ComparableEvent> {
	...
	public ComparableEvent(Impression newImp){
		setMyImp(newImp);
	}
	...
	public int compareTo(ComparableEvent o) {
		ComparableEvent imp = (ComparableEvent) o;
